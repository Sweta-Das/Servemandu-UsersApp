          ...
          child: Column(
            children: [
              ...
              Text.rich(
                TextSpan(
                  children: [
                    TextSpan(text: 'Servemandu is a home solution app that delivers service at your door. It bridges the gap between valuable customers like you and the service providers.', style: TextStyle(fontStyle: FontStyle.italic, fontSize: 17, fontWeight: FontWeight.bold, color: Colors.blueGrey)),
                  ]
                ),
              ),
