// ignore_for_file: library_prefixes, library_private_types_in_public_api, prefer_const_constructors, avoid_unnecessary_containers, sort_child_properties_last
...
class _RegisterScreenState extends State<RegisterScreen>
{
  ...
  Future saveDataToFirestore(User currentUser) async
  {
    FirebaseFirestore.instance.collection("users").doc(currentUser.uid).set({
      ...
      "status": "approved",
      "userCart": ["garbagevalue"], // saving in the firestore as separate lists.
    });
    ...
    //adding tempList to userCart for keeping record (saving locally)
